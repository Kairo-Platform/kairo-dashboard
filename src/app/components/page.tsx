...
import { DoughnutChart, LineChart, mapSelectOptions } from "@/app/lib/utils";
import { useModal } from "@/app/lib/hooks";
import styled from "styled-components";
import { DashboardLayout } from "./dashboard";
import { Icon } from "@iconify/react";
import { PAYMENT_STATUS } from "../lib/shared-constants";
const calendarIcon = "/components/icon-calendar.svg";
        ...
        <Flex direction="column">
          ...
          <Flex direction="column" gap="0.5rem">
            ...
            <Button classes={[ButtonClass.OUTLINED, ButtonClass.WITH_ICON]}>
              ...
              <Image alt="btn-icon" src={calendarIcon} width={15} height={15} />
            </Button>
            <Button
              classes={[ButtonClass.SOLID]}
            ...
            <Button classes={["btn--no-bg", "btn--icon-only"]}>
              <Image alt="btn-icon" src={calendarIcon} width={20} height={20} />
            </Button>
          </Flex>
        </Flex>
