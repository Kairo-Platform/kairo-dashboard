...
import { users as UserService } from "@/services/backOffice/Users";
import { showErrorNotification } from "@/app/lib/utils";
import { getApiData, isApiError } from "@/app/lib/utils/getApiData";
...
export const fetchAuthUser = async () => {
  ...
  try {
    ...
    if (data) setAuthUser(data as AuthUser);
    return response;
  } catch (error: any) {
